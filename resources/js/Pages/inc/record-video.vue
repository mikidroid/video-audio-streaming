...
const vidOptions = {
 ...
 function startRec(){
     ...
     navigator.mediaDevices.getUserMedia(vidOptions) .then((stream)=> {_stream.value,vid.value.srcObject = stream
...
<template>
    ...
    <div>
     ...
     <div class="mt-8 bg-gradient-to-r from-pink-500 to-blue-300 px-5 py-2 pt-5 shadow rounded-xl"  >
